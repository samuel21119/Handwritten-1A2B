...
#
# Generated by export_simulation on Sat Jan 08 00:18:09 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_layer3.sh' script.

./blk_mem_gen_layer3.sh -reset_run
...
./blk_mem_gen_layer3.sh -noclean_files

For more information on the script, please type './blk_mem_gen_layer3.sh -help'.
